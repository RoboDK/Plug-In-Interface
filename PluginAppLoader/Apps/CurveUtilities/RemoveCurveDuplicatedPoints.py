...
# --------------- DESCRIPTION ----------------
#
# Remove subsequent duplicated points in the curves of an object.
#
...
def RemoveCurveDuplicatedPoints(RDK=None, S=None, objects=None):
    """
    Remove subsequent duplicated points in the curves of an object.
    """
    ...
    if objects is None:
        ...
        if not objects:
            objects = RDK.ItemUserPick('Select the object with curves with duplicated points', robolink.ITEM_TYPE_OBJECT)
    ...
    for object_item in objects:
        ...
        for curve in curves:
            curve = cutools.filter_subsequent_duplicated_points(curve, S.SIMPLIFY_TOLERANCE_POINT, S.SIMPLIFY_COMPARE_NORMALS, S.SIMPLIFY_TOLERANCE_NORMALS)
