...
# --------------- DESCRIPTION ----------------
#
# Double-click example (double-click a tree item of a specific type).
#
...
def OnDoubleClickAction():
    """Action to perform when a supported item is double-clicked in RoboDK."""
