...
from _AppUtilities import ShowMessage, APP_OPTION_A_KEY
import os
...
def ActionChecked():
    ...
    RDK.setParam(APP_OPTION_A_KEY, 1.0)
    ShowMessage(RDK, ACTION_NAME, str(RDK.getParam(APP_OPTION_A_KEY)), False)
...
def ActionUnchecked():
    ...
    RDK = robolink.Robolink()
    RDK.setParam(APP_OPTION_A_KEY, 0.0)
    ShowMessage(RDK, ACTION_NAME, str(RDK.getParam(APP_OPTION_A_KEY)), False)
