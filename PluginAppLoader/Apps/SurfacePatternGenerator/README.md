...
The Surface Pattern Generator (SPG) App for RoboDK lets you project simple geometric patterns directly onto 3D object surfaces.
It automates path mapping for surface finishing, spray painting, welding, polishing, and area scanning by automatically linking the projected geometry to a Curve Follow Project and generating executable robot programs. 
...
- **Automated Program Generation**: Automatically creates and solves a Curve Follow Project with custom TCP tilt angles and operation speeds.
