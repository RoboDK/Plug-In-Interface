...
**Important**: Checking the **Run on robot** option will move the real robot if the real robot is connected. Make sure the connection is properly established and you are operating in a safe environment.
