...
public:
    ...
    enum TypeEvent {
        ...
        /// Moved event: Something has moved, such as a robot, reference frame, object or tool. This event is usually followed by a render event.
        EventMoved=2,

        /// An item has been added or deleted in the station or the active station has changed. This event is usually followed by a Render event.
        EventChanged=3
    };
    ...
    virtual QString PluginLoad(QMainWindow *mw, QMenuBar *menubar, QStatusBar *statusbar, IRoboDK *rdk, const QString &settings=""){return "";};
    ...
    /// \return
    virtual bool PluginItemClick(Item item, QMenu *menu, TypeClick click_type){ return false; }
    ...
    /// \param value
    /// \return
    virtual QString PluginCommand(const QString &command, const QString &value){ return ""; };
    ...
    /// If event_type is \ref EventRender you can render your own graphics here in OpenGL. This function is called every time the OpenGL window is displayed. The RoboDK OpenGL context is active at this moment.
