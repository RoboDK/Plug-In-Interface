Draw OpenGL shaders in the 3D view
===========================
...
* PluginEvent with event type DrawGeometry is triggered when we need to redraw the 3D view: [pPlugin->PluginEvent](https://robodk.com/doc/en/PlugIns/class_i_app_robo_d_k.html#ab024375af071dcf8bdd7ce20672d00d0). This function is called with the OpenGL context active.
